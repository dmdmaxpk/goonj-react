            ...
            <div className="sectionContainers">
                ...
                <GridContainer>
                    ...
                    <GridItem xs={12} sm={12} md={2}>
                        <img style={{overflowY: "hidden", height: "272px", width: "90%"}} className="childImg" src="https://cdn.collider.com/wp-content/uploads/2013/06/man-of-steel-poster-general-zod.jpg" />
