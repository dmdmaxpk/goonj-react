        ...
        return(
            <div>
                <div className="profileHead" onClick={this.showProfile}>
                    <p className="profileHeading floatLeft">Terms & Conditions</p>
                ...
                <Collapse in={this.state.showProfile} timeout="auto" unmountOnExit={true}>
                    <GridContainer className="userInfoContainer">
                            <GridItem style={{textAlign: "center"}} xs={12} sm={12} md={12}>
                                <p style={{textTransform: "none"}}><Link to="/terms-conditions" style={{color: "#4AA6E5"}}>Click here </Link>to read our <Link to="/terms-conditions" style={{color: "#4AA6E5"}}>Terms & Conditions</Link>.</p>
                            </GridItem>
                    </GridContainer>
                </Collapse>
            </div>
